...
// PersesOperatorDockerConfig represents the configuration needed to generate the docker section of a goreleaser config.
// It is written in a dedicated package to be reused by different scripts.
func PersesOperatorDockerConfig(cfg TestConfig) *goreleaser.DockerConfig {
