...
func main() {
	...
	flag.StringVar(&persesImage, "perses-default-base-image", "docker.io/persesdev/perses:v0.50.1", "The default image used for the Perses Deployment or StatefulSet operands")
