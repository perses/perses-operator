...
func (in *OAuth) DeepCopyInto(out *OAuth) {
	*out = *in
	in.SecretSource.DeepCopyInto(&out.SecretSource)
	if in.ClientIDPath != nil {
		in, out := &in.ClientIDPath, &out.ClientIDPath
		*out = new(string)
		**out = **in
	}
...
func (in *PersesGlobalDatasource) DeepCopy() *PersesGlobalDatasource {
	...
	out := new(PersesGlobalDatasource)
	in.DeepCopyInto(out)
	return out
}
...
func (in *PersesGlobalDatasourceList) DeepCopyInto(out *PersesGlobalDatasourceList) {
	*out = *in
	...
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]PersesGlobalDatasource, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *PersesGlobalDatasourceList) DeepCopy() *PersesGlobalDatasourceList {
	...
	out := new(PersesGlobalDatasourceList)
	in.DeepCopyInto(out)
	return out
}
...
func (in *PersesGlobalDatasourceStatus) DeepCopy() *PersesGlobalDatasourceStatus {
	...
	out := new(PersesGlobalDatasourceStatus)
	in.DeepCopyInto(out)
	return out
}
...
func (in *PersesSpec) DeepCopyInto(out *PersesSpec) {
	*out = *in
	...
	if in.LogMethodTrace != nil {
		in, out := &in.LogMethodTrace, &out.LogMethodTrace
		*out = new(bool)
		**out = **in
	}
...
func (in *Provisioning) DeepCopyInto(out *Provisioning) {
	*out = *in
	if in.SecretRefs != nil {
		...
		*out = make([]*ProvisioningSecret, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(ProvisioningSecret)
				(*in).DeepCopyInto(*out)
			}
		}
	}
