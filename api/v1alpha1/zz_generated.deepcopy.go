...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PersesSecret.
func (in *PersesSecret) DeepCopy() *PersesSecret {
	if in == nil {
		return nil
	}
	out := new(PersesSecret)
	in.DeepCopyInto(out)
	return out
}
